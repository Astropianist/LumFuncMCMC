...
def plotProtoEvol(fitpostprotorig, reds, Lmin=42.0, Lmax=43.5, Lnum=1001, sa=-1.6):
    ...
    plt.tight_layout()
    fig.savefig("CosmicEvolCOSMOS_PCnewN673.png", bbox_inches='tight', dpi=300)
...
def plotProtoEvolProp(fitpostprotorig, reds, dzs, sa=-1.6):
    ...
    plt.tight_layout()
    fig.savefig("CosmicEvolCOSMOSPropnewN673.png", bbox_inches='tight', dpi=300)
...
def plotEvolution(fitpostfs, reds, Lmin=42.0, Lmax=43.5, Lnum=1001, sa=-1.6):
    ...
    ax.set_ylim(1.0e-6, 3.0e-2)
    ax.legend(loc='best', frameon=False)
    fig.savefig("CosmicEvolCOSMOS_newN673.png", bbox_inches='tight', dpi=300)
...
def plotDensityEvol(fit_names_orig, reds, dens_vals, Lmin=42.0, Lmax=43.5, Lnum=1001, ymin=1.0e-6, ymax=3.0e-2, sa=-1.6):
    ...
    fig.savefig("CosmicDensEvolCOSMOS_newN673_3bins.png", bbox_inches='tight', dpi=300)
...
def plotStuffNew(fitpostfs, reds, sobfile='sty378_supp/SC4K_full_LFs_Table_C1.fits', sobothers='sty378_supp/SSC4K_compilation_Table_C2.fits', Lmin=42.0, Lmax=44.25, Lnum=1001, sobkeys=['IA427 ($z=2.5$)', 'IA505 ($z=3.2$)', 'IA679 ($z=4.6$)'], sobzs=[2.5, 3.2, 4.6], maxdiff=0.21, llims=[43.1, 43.1, 43.2], ymin=5.0e-7, ymax=3.0e-2, sa=-1.6):
    ...
    fig.savefig("FullLitCompnewN673.png", bbox_inches='tight', dpi=300)
...
def NewProc():
    ...
    fits_z45 = op.join('LFMCMCOdin', 'ODIN_fsa0_sa-1.49_mcf50_ll45.0_ec2_contam_0.01_cb10newcontam', 'N673_ll_431_all_fitposterior_ODIN_fsa0_sa-1.49_mcf50_ll45.0_ec2_contam_0.01_cb10newcontam_nb50_nw200_ns5000_mcf50_ec_2_env0_bin1.dat')
